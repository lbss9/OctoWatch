...
public sealed partial class SettingsPage : Page
{
    ...
    private async void OnSignIn(object sender, RoutedEventArgs e)
    {
        ...
        {
            ShowAuth(InfoBarSeverity.Error, CoreError.Describe(ex));
    ...
    // Toggle/slider only adjust the UI; the background changes only on "Apply".
    ...
    private async void OnCheckUpdates(object sender, RoutedEventArgs e)
    {
        ...
        UpdateStatus.Text = Loc.Get("Settings_Updating");
        var result = await UpdateService.CheckAndApplyAsync();
        UpdateSpinner.IsActive = false;
        CheckUpdatesButton.IsEnabled = true;
        UpdateStatus.Text = result switch
        {
            UpdateResult.UpToDate => Loc.Get("Settings_UpToDate"),
            UpdateResult.Updating => Loc.Get("Settings_Updating"),
            UpdateResult.NotInstalled => Loc.Get("Settings_UpdateDevBuild"),
            _ => Loc.Get("Settings_UpdateFailed"),
        };
    }
